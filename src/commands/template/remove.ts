...
export default class SmockitTemplateInit extends SfCommand<SmockitTemplateInitResult> {
  ...
  public async run(): Promise<SmockitTemplateInitResult> {
    console.log(chalk.yellow('⚠️  Heads up! This command will be retired soon. Please start using "sf smockit template remove". All new updates will be available in new command.'));
    try {
